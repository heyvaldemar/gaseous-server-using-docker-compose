...
- **`mariadb:11.4` was rebuilt upstream**; the pin moved from `sha256:80494b981069…` to `sha256:70cc072b29b4…`. Same version, same tag, a rebuilt base image — the usual shape of a security fix in a base layer.
